...
calibpkl=//mnt/liying.cibr.ac.cn_Data_Temp/marmoset_camera3_cxf/2023-11-27-calib/*.calibpkl
model_name='ball'
...
python -m lilabnext.multview_marmoset_track.t1_realtime_view --checkpoint D:/balllatest.full.engine --calibpkl D:/ball.calibpkl
python -m lilabnext.multview_marmoset_track.t1_realtime_position --checkpoint D:/balllatest.full.engine --calibpkl D:/ball.calibpkl
python -m lilabnext.multview_marmoset_track.t1_realtime_position --checkpoint D:/balllatest.full.engine --calibpkl D:/ball.calibpkl